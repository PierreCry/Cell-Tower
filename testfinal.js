...
function preload() {
    ...
    game.load.video('intro', 'intro.mp4');
    game.load.video('credits', 'creditsv2.mp4');
...
function start() {
    ...
    game.time.events.add(72000, changeSource, this);
...
function changeSource() {
    ...
    var antenne = game.add.sprite(29*40,4*40, '01', 1);
    antenne.onde=new Array();
    antenne.onde[0] = new Phaser.Circle(29*40,4*40,1);
